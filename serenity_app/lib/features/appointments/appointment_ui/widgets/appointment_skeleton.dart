...
class AppointmentItemSkeleton extends StatelessWidget {
  const AppointmentItemSkeleton({Key? key}) : super(key: key);
                ...
                Row(
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _buildSkeletonBox(width: screenWidth * 0.12, height: 12),
                ...
                Row(
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _buildSkeletonBox(width: screenWidth * 0.1, height: 12),
                        const SizedBox(height: 6),
                        _buildSkeletonBox(width: screenWidth * 0.2, height: 14),
                      ],
                    ),
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _buildSkeletonBox(width: screenWidth * 0.15, height: 12),
                        const SizedBox(height: 6),
                        _buildSkeletonBox(width: screenWidth * 0.25, height: 14),
                      ],
                    ),
